...
CONFIG(debug, debug|release) {
    ...
    LIBS +=  -lmodcryptod -lplatformkeystoraged -lplatformcryptod -lplatformsettingsd -lrmscryptod
} else {
    LIBS +=  -lmodcrypto -lplatformkeystorage -lplatformcrypto -lplatformsettings -lrmscrypto
}
